...
Data source contains training, test, features, subject data sets, readme 
In data source training, test sets and features, subjects are seperated in different files.  
In a nutshell we merged all data into a data frame and created some functions for explaratory analysis. 
--------------------------------------------------------------------------------------------------------------------
